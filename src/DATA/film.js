...
export const FilmSpis = [
  {
    ...
    id: 3,
    name: 'Kraina lodu II',
    text: 'Elsa i Anna wraz z przyjaciółmi udają się do Zaczarowanego Lasu w poszukiwaniu pomocy dla swego Królestwa.',
    plot: 'Akcja kontynuacji filmu jest osadzona trzy lata po wydarzeniach z pierwszej części. W Arendelle panuje ład pod panowaniem Elsy, jednak królowa zaczyna słyszeć dziwny głos, który nawołuje ją z północy. Wraz z Anną, Kristoffem i Olafem postanawiają wyruszyć w drogę, aby poznać prawdę o tym, co przywołuję Elsę i odkryć prawdę o jej mocach. Chociaż nie jest to na razie potwierdzone, nowy zwiastun animacji sugeruje, jakoby Anna również posiadała magiczne moce! Co więcej, wygląda to, jakby siostra Elsy była w stanie władać... ogniem!',
    cost: 13,
    reservation: [2, 3],
    places: 10,
  }, {
